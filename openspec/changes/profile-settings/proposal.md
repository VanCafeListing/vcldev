...
- **Mockup gap**: Notification, Privacy Policy, and Terms of Use rows have a chevron (implying navigation) but no destination screen was designed for any of them. Default: each navigates to a minimal placeholder screen (title + "Content coming soon") rather than being dead/unresponsive or inventing real legal copy or settings.
