...
- Implement the Search tab from its own Figma frame (75:2474): a "Tailored to your needs" heading, a labelled search input with a separate filter button beside it, "Recent searches" rendered as chips, and a "Recommendation" list of cafe cards. This is a designed screen, not the Home list with a search bar bolted on.
